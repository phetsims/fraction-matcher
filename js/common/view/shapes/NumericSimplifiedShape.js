...
/**
 * Numeric shape (simplified) for the 'Fraction Matcher' screen.
 *
...
define( function( require ) {
  ...
  function NumericSimplifiedShape( options ) {
    ...
    if ( integralPart ) {
      ...
      fractionNode.setX( fractionNode.getWidth() / 4 );

      // add integral part
      this.addChild( new Text( integralPart, {font: FONTBIG, centerY: 0, centerX: -fractionNode.getWidth() / 4 } ) );
    }
    else {
      // add fraction node
