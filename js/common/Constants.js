...
define( function( require ) {
  ...
  function Constants( game ) {
    ...
    if ( game === mixedNumbersTitleString ) {
      ...
      // level 2
      this.LEVEL_DESCRIPTION[1].fractions.push(  // add more mixed fractions
        [3, 2],
        [4, 3],
        [5, 3],
        [6, 3],
      ...
      // level 3
      this.LEVEL_DESCRIPTION[2].fractions.push(  // add more mixed fractions
        [5, 3],
        [6, 5],
        [7, 5],
        [8, 5],
      ...
      // level 4
      this.LEVEL_DESCRIPTION[3].fractions.shift(); // remove one 13/7 fraction
      this.LEVEL_DESCRIPTION[3].fractions.push(  // add more mixed fractions
        [6, 5],
        [7, 5],
        [8, 5],
        [7, 6],
      ...
      // level 6
      this.LEVEL_DESCRIPTION[5].fractions.push( // add more mixed fractions
        [10, 6],
        [11, 6],
        [8, 7],
        [11, 7],
      ...
      // level 7
      this.LEVEL_DESCRIPTION[6].fractions.push( // add more mixed fractions
        [8, 6],
        [9, 6],
        [10, 6],
        [8, 7],
      ...
      // level 8
      this.LEVEL_DESCRIPTION[7].fractions.push( // add more mixed fractions
        [6, 5],
        [7, 5],
        [8, 5],
        [9, 5],
