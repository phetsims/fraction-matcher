...
define( function( require ) {
  ...
  // level 6
  // add more mixed fractions
  MixedNumbersConstantsConstants.LEVEL_DESCRIPTION[5].fractions.push( Fraction.fraction( 10, 6 ), Fraction.fraction( 11, 6 ), Fraction.fraction( 8, 7 ), Fraction.fraction( 11, 7 ), Fraction.fraction( 12, 7 ), Fraction.fraction( 12, 8 ), Fraction.fraction( 13, 8 ), Fraction.fraction( 15, 8 ), Fraction.fraction( 12, 9 ), Fraction.fraction( 13, 9 ), Fraction.fraction( 14, 9 ), Fraction.fraction( 15, 9 ), Fraction.fraction( 16, 9 ), Fraction.fraction( 17, 9 ) );

  // level 7
  // add more mixed fractions
  MixedNumbersConstantsConstants.LEVEL_DESCRIPTION[6].fractions.push( Fraction.fraction( 8, 6 ), Fraction.fraction( 9, 6 ), Fraction.fraction( 10, 6 ), Fraction.fraction( 8, 7 ), Fraction.fraction( 9, 7 ), Fraction.fraction( 10, 7 ), Fraction.fraction( 11, 7 ), Fraction.fraction( 12, 7 ), Fraction.fraction( 13, 7 ), Fraction.fraction( 9, 8 ), Fraction.fraction( 10, 8 ), Fraction.fraction( 11, 8 ), Fraction.fraction( 12, 8 ), Fraction.fraction( 13, 8 ), Fraction.fraction( 14, 8 ), Fraction.fraction( 15, 8 ), Fraction.fraction( 10, 9 ), Fraction.fraction( 11, 9 ), Fraction.fraction( 12, 9 ), Fraction.fraction( 13, 9 ), Fraction.fraction( 14, 9 ), Fraction.fraction( 15, 9 ), Fraction.fraction( 16, 9 ), Fraction.fraction( 17, 9 ) );
  MixedNumbersConstantsConstants.LEVEL_DESCRIPTION[6].numericScaleFactors = [3, 6, 7];

  // level 8
  // add more mixed fractions
  MixedNumbersConstantsConstants.LEVEL_DESCRIPTION[7].fractions.push( Fraction.fraction( 6, 5 ), Fraction.fraction( 7, 5 ), Fraction.fraction( 8, 5 ), Fraction.fraction( 9, 5 ), Fraction.fraction( 7, 6 ), Fraction.fraction( 8, 6 ), Fraction.fraction( 9, 6 ), Fraction.fraction( 10, 6 ), Fraction.fraction( 11, 6 ) );
