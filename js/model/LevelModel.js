  ...
  inherit( PropertySet, LevelModel, {
    ...
    generateLevel: function() {
      ...
      for ( var i = 0; i < this.gameModel.MAXIMUM_PAIRS; i++ ) {
        ...
        var fillType = this.levelDescription.fillType[ phet.joist.random.randomIntegerBetween( this.levelDescription.fillType.length - 1 ) ];
        ...
        type = shapes[ phet.joist.random.randomIntegerBetween( shapes.length - (type === numberType ? 2 : 1) ) ];
